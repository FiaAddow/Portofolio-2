...
import { Header } from '@/components/HeaderProjectpage'
    ...
    <div>
      <div className="mb-20 space-y-6">
        ...
        <div className="rounded-md border">
          ...
          <div className="divide-inherit grid grid-cols-1 divide-y lg:grid-cols-2 lg:divide-x lg:divide-y-0">
        ...
        {description && (
          <CustomPortableText
            ...
            type={data?._type || null}
            path={['description']}
            paragraphClasses="font-sans max-w-3xl text-xl text-gray-800"
